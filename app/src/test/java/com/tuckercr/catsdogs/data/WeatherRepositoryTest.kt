...
class WeatherRepositoryTest {
    ...
    @Test
    fun `fetchCurrentWeather returns missing api key without calling api`() {
        runBlocking {
    ...
    @Test
    fun `fetchCurrentWeather trims request values and prefers provided location label`() {
        runBlocking {
            val api = FakeOpenWeatherApi()
    ...
    @Test
    fun `fetchForecast uses coordinates instead of city query when provided`() {
        runBlocking {
            val api = FakeOpenWeatherApi()
            val repository = repository(api, apiKey = "test-key")
    ...
    @Test
    fun `fetchForecast maps OpenWeather error body to failure message`() {
        runBlocking {
